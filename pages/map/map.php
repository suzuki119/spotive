  ...
  <body>
    ...
    <main class="l-main">
      <div class="sports-map">
        <aside class="sports-map__side">
          <details class="sports-map__filters" open>
        ...
        <section class="sports-map__canvas">
          ...
          <div class="map-tools">
            ...
            <button id="fit" type="button">結果全体を表示</button>
          </div>
    ...
    <script type="application/json" id="map-tournaments"><?= $mapTournamentsJson ?></script>
